...
Requirements
Silicon Labs SiWx91x development kit
Simplicity Studio 5
Compatible SDK version, you can install it via Simplicity Studio or download it from our GitHub gecko_sdk or simplicity_sdk
Compatible WiSeConnect SDK, you can install it via Simplicity Studio or download it from our GitHub wiseconnect_sdk
...
See How to Contribute and CONTRIBUTING.md for details.
...
Documentation
The official Wi-Fi documentation is available on the Developer Documentation page.
